...
export function shippingEmailHtml({
  ...
  const rows = lineItems
    .map(
      (i) => `
    <tr>
      <td style="padding:9px 0;border-bottom:1px solid #DEDEDE;color:#533113;font-size:14px;">
        ${i.name}${i.size ? ` — ${i.size}` : ""}${i.color ? ` / ${i.color}` : ""}
      </td>
      <td style="padding:9px 0;border-bottom:1px solid #DEDEDE;color:#533113;font-size:14px;text-align:center;">&#xD7;${i.quantity}</td>
      <td style="padding:9px 0;border-bottom:1px solid #DEDEDE;color:#533113;font-size:14px;text-align:right;">GH&#x20B5;${(i.price * i.quantity).toFixed(2)}</td>
    </tr>`
    )
    .join("");
  ...
  <tr><td align="center">
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border:1px solid #DEDEDE;">
      ...
      <tr><td style="padding:36px 40px 28px;">
        <p style="margin:0 0 4px;color:#533113;font-size:20px;">Your order is on its way!</p>
        ...
        <p style="margin:0 0 24px;color:#533113;font-size:15px;line-height:1.8;">
          Your order <strong>#${shortId}</strong> has been dispatched and is heading to you.
          Our delivery team will contact you to arrange the final handover.
        </p>

        <table width="100%" cellpadding="0" cellspacing="0" style="background:#FFFBF6;border:1px solid #DEDEDE;margin-bottom:28px;">
          <tr><td style="padding:16px 20px;">
            <p style="margin:0 0 4px;color:#533113;font-size:11px;letter-spacing:2px;opacity:0.5;">DELIVERING TO</p>
            <p style="margin:0;color:#533113;font-size:14px;line-height:1.7;">${address}, ${city}</p>
          </td></tr>
        </table>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
          <tr>
            <td style="color:#533113;font-size:16px;font-weight:bold;padding-top:4px;">Total Paid</td>
            <td style="text-align:right;color:#533113;font-size:16px;font-weight:bold;padding-top:4px;">GH&#x20B5;${total.toFixed(2)}</td>
          </tr>
        </table>
